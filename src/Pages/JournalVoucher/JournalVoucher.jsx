    ...
    <Layout>
      <div>
        <PageHeader
          ...
          subtitle="Add edit and manage Journal Voucher"
          breadcrumb="Journal Voucher"
          actions={
            <PrimaryButton
              label="+ Add Ledger"
              onClick={() => navigate("/add-journal-voucher")}
            />
          }
        />
        ...
        <div className="table-container">
          <DataTable
            ...
            onEdit={(row) => navigate("/add-journal-voucher", { state: { rowData: row } })}
