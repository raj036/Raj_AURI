      ...
      tooltip: {
        ...
        callbacks: {
          label: function (context) {
            ...
            const income = orders * 1000;
            const revenue = orders * 4000;

            const formattedRevenue = revenue.toLocaleString("en-IN");
            const formattedIncome = income.toLocaleString("en-IN");
            return [
              `Income: ${formattedIncome.toLocaleString()}`,
              `Expenses: ₹${formattedRevenue.toLocaleString()}`,
            ];
          },
        },
      },
  ...
  return (
    <div className="card mb-4 p-4 rounded-4">
      <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
        <h4 className="fw-bold mb-0">Financial Summary</h4>
      </div>
      ...
      <div className="row mb-4">
        {accountFinancialMetrics.map((metric, idx) => (
      ...
      <div className="card border p-3 rounded-3 mt-4">
        <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
          <div>
