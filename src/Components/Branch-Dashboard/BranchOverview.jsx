  ...
  return (
    <div className="card shadow-sm rounded-4 mb-4">
      <div className="card-body p-4">
        <h5 className="fw-bold mb-1">Branch Overview</h5>
        <p className="text-muted mb-4">
          High-level business metrics and employee distribution across the
          organization
        </p>
        ...
        <div className="row mb-4">
          <div className="col-12">
            <div className="row g-3">
              {branchOverview.metrics.map((metric, idx) => (
                ...
                tooltip: {
                  ...
                  callbacks: {
                    label: function (context) {
                      return `Customer acquisition rate: ${context.parsed.y}%`;
                    },
                  },
                },
              },
