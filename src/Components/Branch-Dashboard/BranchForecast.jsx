...
function BranchForecast({
  ...
  const chartData1 = {
    ...
    datasets: [
      {
        label: "Actual Sales",
        data: [40, 50, 20, 25, 35, 55, 45, 30, 30, 15, 25],
      ...
      },
      {
        ...
        data: [20, 30, 40, 35, 45, 25, 35, 45, 20, 55, 25],
  ...
  const forecastChart = useMemo(() => {
    ...
    if (!forcastChartData || forcastChartData.length === 0) {
      return {
        labels: [],
        datasets: [],
      };
    ...
    return {
      labels: forcastChartData.map((item) => item.day),
      datasets: [
        {
          label: "Actual Sales",
          data: forcastChartData.map((item) =>
            Number(item["Actual Sales"].replace(/,/g, ""))
          ),
          borderColor: "#1570EF",
        ...
        },
        {
          ...
          data: forcastChartData.map((item) =>
            Number(item["Projected Sales"].replace(/,/g, ""))
          ),
          borderColor: "#53B1FD",
        ...
        },
        {
          ...
          data: forcastChartData.map((item) =>
            Number(item["Service Demand"].replace(/,/g, ""))
          ),
          borderColor: "#47CD89",
          backgroundColor: "rgba(71, 205, 137, 0.2)",
          tension: 0.4,
          borderWidth: 2.5,
          pointRadius: 5,
          pointHoverRadius: 6,
    ...
    plugins: {
      ...
      tooltip: {
        ...
        callbacks: {
          ...
          //   const customer = forcastChartData[index];
          //   return [
          //     `Actual Sales: ${customer["Actual Sales"]}`,
          //     `Projected Sales: ₹${customer["Projected Sales"].toLocaleString()}`,
          //     `Service Demand: ₹${customer["Service Demand"].toLocaleString()}`,
          //   ];
          // },
  ...
  return (
    <div className="card mb-4 p-4 rounded-4">
      <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
        <h4 className="fw-bold mb-0">Forecast</h4>
      ...
      <div className="row mb-4">
        {branchForecastMetrics.map((metric, idx) => (
              ...
              tooltip: {
                ...
                callbacks: {
                  label: function (context) {
                    ...
                    return [
                      `Forcast: ${orders}`,
                      `Actual: ₹${formattedRevenue.toLocaleString()}`,
                    ];
                  },
                },
              },
